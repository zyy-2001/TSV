...
from llm_layers3 import add_tsv_layers
...
def main(): 
    ...
    parser.add_argument('--num_A', type=int, default=1)
    parser.add_argument('--num_B', type=int, default=1)
    ...
    if args.gene:
        ...
        # labels = [gt_label_test, gt_label_wild, gt_label_wild] # Full
        # prompts = [test_prompts, train_prompts, train_prompts]
        ...
        tsv_layers = add_tsv_layers(device, model, args.r, args.num_A, args.num_B, args)

    
        optimizer = torch.optim.AdamW(list(tsv_layers.parameters()), lr=args.lr)
